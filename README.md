...
**Advance log (activity → result):** [docs/ADVANCE-LOG.md](./docs/ADVANCE-LOG.md)
...
| Port | Folder | Role |
|------|--------|------|
| **8253** | this repo | M1 demo (neural→symbolic) |
| **8259** | this repo | Neural→neural layer-loss (`python3 nn_layer_loss_server.py`) |
| **8260** | this repo | Locator v1 first-break (`python3 locator_server.py`) |
...
| Track B family L20 vector (DEV) | `./.venv-phase9/bin/python run_trackb_falsex.py --family-vector` | Yes (GPU) |
